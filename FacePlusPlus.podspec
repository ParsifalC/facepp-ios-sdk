#
#  Be sure to run `pod spec lint FacePlusPlus.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/mingweizhang/facepp-ios-sdk"
  ...
  s.source       = { :git => "https://github.com/mingweizhang/facepp-ios-sdk.git", :tag =>  s.version.to_s}
